...
custom_gemm = load(
    name="tcgen05_mxfp8_2cta_256n_triple_buffer_tmem",
    sources=[
        "tcgen05_mxfp8_2cta_256n_triple_buffer_tmem.cpp",
        "tcgen05_mxfp8_2cta_256n_triple_buffer_tmem.cu",
    ],
    extra_cuda_cflags=[
        "-O3",
        "--use_fast_math",
...
def benchmark():
    ...
    for M, K, N in sizes:
        ...
        print(
            f"  Custom kernel:       {custom_us:7.3f} us ({custom_tflops:6.2f} tflops)"
        )
